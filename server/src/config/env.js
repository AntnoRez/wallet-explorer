...
export const config = {
  ...
  api: {
     ...
     * Ключ tonapi — TON.
     *
     * Бесплатный тариф даёт около запроса в секунду; без ключа лимит ещё
     * жёстче. Провайдер выстраивает запросы в очередь с паузой 1.1 с.
     */
    tonApiKey: str('TONAPI_KEY', ''),
  },
